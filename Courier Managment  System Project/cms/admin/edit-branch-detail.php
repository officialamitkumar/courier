...
$bcountry=$_POST['country'];
 $query=mysqli_query($con,"update tblbranch set BranchName='$branchname',BranchContactnumber='$contnum',BranchEmail='$bemail',BranchAddress='$baddress',BranchCity='$bcity',BranchState='$bstate',BranchPincode='$bpincode',BranchCountry='$bcountry' where  ID='$eid'");
    ...
    if ($query) {
    $msg="Branch Detail has been Updated.";
  }
  else
    {
...
?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="<?php  echo $row['BranchContactnumber'];?>" id="" name="contactnumber" maxlength="10" required="true">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="<?php  echo $row['BranchPincode'];?>" id="" name="pincode" required="true">
                                        </div>
                                    </div>
                                     <div class="form-group row">
